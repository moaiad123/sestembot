...
if (message.content.startsWith('!bcall')){
 if (message.author.id !== '507975509473361930') return message.reply('** هذا الأمر قفط لصاحب البوت و شكراًً **')
 if(!message.author.id === '507975509473361930') return;
...
m.sendMessage(args)
 ...
 client.on('message' , function (message){
      var token = 'NTM0Nzc1NTgxNjUzNDY3MTM3.Dx_QmA.ri-XbcjU6OFKM5MmWBozvYmtWxg'; // التوكن هنا بس
      if(message.content === '!restart') {
if(message.author.id !== '507975509473361930') return message.reply('**الامر خاص بـ صاحب البوت وشكرا**');
          client.destroy();
